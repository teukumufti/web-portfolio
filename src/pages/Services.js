        ...
        <div>
            ...
            <div className="flex justify-between relative bottom-[260px]">
                <button class="rounded-full text-slate-50 bg-aqua-100 ml-3 w-8 h-8" type="button">
                    <svg className="inline m-auto" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 256 512" height="1.5em" width="1em" xmlns="http://www.w3.org/2000/svg">
