...
function About() {
    return (
        <div>
            <div class="grid grid-cols-2 gap-4 text-white-50 justify-items-center">
                <div className="m-auto">
                    ...
                    <button type="button" class="inline-block px-6 py-2 border-2 mt-10 border-aqua-100 text-white-100 hover:bg-aqua-100">Download CV</button>
                </div>
                <div>
